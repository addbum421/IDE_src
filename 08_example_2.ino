...
// get a distance reading from the USS
  ...
  if (dist_raw == 0.0) dist_raw = last_dist_raw;
  else last_dist_raw = dist_raw;
...
// output the read value to the serial port
  ...
  if (dist_raw <= 200) led_power = -(dist_raw - 200) * 2.55;
  else led_power = (dist_raw -200) * 2.55;

  analogWrite(PIN_LED, led_power);
